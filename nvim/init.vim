...
"vimux
    ...
    " Plug 'lambdalisue/fern-git-status.vim'  "No funcionó
...
nnoremap <leader>so :<C-u>Unite -start-insert -auto-resize outline<CR><ESC>
...
function! FernInit() abort
  ...
  nmap <buffer> q :FernDo close<CR><C-w>=
  nmap <buffer> <leader>f :FernDo close<CR><C-w>=
...
" Suggested configuration for working with SKU project (that uses Laravel and Vue) {{{
...
" nmap <leader>fm :Fern ./app/Model/<CR>|                " Explore Model
" nmap <leader>fd :Fern ./database/migrations/<CR>|      " Explore Database
" nmap <leader>fr :Fern ./routes/<CR>|                   " Explore Routes
" nmap <leader>fv :Fern ./resources/views/<CR>|          " Explore View (view file from Laravel)
" nmap <leader>fh :Fern ./app/Helpers/<CR>|              " Explore Helper
" nmap <leader>ffv :Fern ./frontend/src/views/<CR>|      " Explore Fronted Views (Vue's view file)
" nmap <leader>ffc :Fern ./frontend/src/components/<CR>| " Explore Fronted Component
